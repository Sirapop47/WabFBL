<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SerieA.aspx.cs" Inherits="FBL.SerieA" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Calcio Serie A</title>
    <meta charset="utf-8">
...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
          <a class="navbar-brand">Calcio Serie A</a>
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
              <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
                  <li class="nav-item active">
                      <a class="nav-link" href="Laliga.aspx">Laliga <span class="sr-only">(current)</span></a>
              ...
              <form class="form-inline my-2 my-lg-0">
                  <button class="btn btn-outline-dark my-2 my-sm-0" type="submit"><a href ="Index.aspx" class="nav-link">Back to Home</a></button>
              </form>
                ...
                <div class="tab-content" id="pills-tabContent">
                  <div class="tab-pane fade  show active " id="pills-Tables" role="tabpanel" aria-labelledby="pills-Tables-tab">
                      <div class="container"> 
                          ...
                          <asp:PlaceHolder ID="SerieAPlaceHolder" runat="server"></asp:PlaceHolder>
                  ...
                  <div class="tab-pane fade" id="pills-Players" role="tabpanel" aria-labelledby="pills-Players-tab">
                      ...
                      <asp:PlaceHolder ID="phPlayerSA" runat="server"></asp:PlaceHolder>
                  </div>
                </div>
