<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="L1.aspx.cs" Inherits="FBL.L1" %>
...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
          <a class="navbar-brand">League 1</a>
            ...
            <div class="container">
                ...
                <div class="tab-content" id="pills-tabContent">
                  ...
                  <div class="tab-pane fade" id="pills-Players" role="tabpanel" aria-labelledby="pills-Players-tab">
                      <asp:PlaceHolder ID="phPlayerL1" runat="server"></asp:PlaceHolder>
                  </div>
                </div>
